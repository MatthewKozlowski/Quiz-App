...
<button type="button" class="moveOn">MoveOn</button>`
    ...
    <button type="button" class="moveOn">MoveOn</button>`
        ...
        <img src="https://i.imgur.com/RoLCztT.jpg" class="imageSizing">
    </div>
    <button type="button" class="moveOn">MoveOn</button>`
        ...
        <img src="http://static1.squarespace.com/static/539dffebe4b080549e5a5df5/53fcdceee4b0b801964aedb1/5a9ef692e2c483767c8ecb0b/1524340523771/beverage-cocktail-decorative-napkins-sawyer-goat-museum-outlets.jpg" class="imageSizing">
    </div>
    <button type="button" class="moveOn">MoveOn</button>`
        ...
        <img src="https://s3.amazonaws.com/file.imleagues/Images/Teams/Uploaded/201802/201822142647906dafc8cf55e71f60e768dee7a828b291c.jpg" class="imageSizing">
    </div>
...
function incorrectAnswerDisplay() {
    if (numberIncorrect === 1 && questionNumber < STORE.length) {
        ...
        <img src="https://i.redd.it/dr5obwe06d811.png" class="imageSizing">
    </div>
    <button type="button" class="moveOn">MoveOn</button>`
        ...
        <img src="https://i0.wp.com/lh4.googleusercontent.com/-oG3nrZqC7BI/UZA-IiB136I/AAAAAAAAJDs/yZ-JD8v6l0A/s640/blogger-image--1256441326.jpg?ssl=1" class="imageSizing">
    </div>
    <button type="button" class="moveOn">MoveOn</button>`
        ...
        <p>The correct answer was: ${STORE[questionNumber-1].correctAnswer}.</p>
        <img src="https://images.rapgenius.com/24e49e891db44863cfb55d11dc31bd83.1000x666x1.jpg" class="imageSizing">
    </div>
    <button type="button" class="moveOn">MoveOn</button>`
        ...
        <p>The correct answer was: ${STORE[questionNumber-1].correctAnswer}.</p>
        <img src="https://media-cdn.tripadvisor.com/media/photo-s/01/44/db/96/doe-a-deer-a-female-deer.jpg" class="imageSizing">
    </div>
    <button type="button" class="moveOn">MoveOn</button>`
        ...
        <p>I don't.</p>
        <p>The correct answer was: ${STORE[questionNumber-1].correctAnswer}.</p>
        <img src="https://www.crowdfunder.co.uk/uploads/projects/14789.png?1424100369" class="imageSizing">
    </div>
    <button type="button" class="seeResults">See Results!</button>`
    } else if (questionNumber === STORE.length) {
        return `<div class="incorrectAnswerDisplay">
